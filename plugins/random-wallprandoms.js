...
let fgif = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`️u`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `🧿 𝙼𝚎𝚗𝚑𝚎𝚛𝚊 𝙲𝚑𝚊𝚗 𝙱𝚘𝚝 🔮`, 'jpegThumbnail': false }}}
let apikey = keysxxx
